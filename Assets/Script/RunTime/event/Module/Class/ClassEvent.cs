...
public class ClassEvent : BaseEvent
{
    public override async void GetInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        NetworkTCPServer.HttpSendAsync(pkg.Context, inf, EventType.ClassEvent, OperateType.GET);
    }
    ...
    public override async void AddEvent(AsyncExpandPkg pkg)
    {
        ...
        NetworkTCPServer.HttpSendAsync(pkg.Context, body, EventType.ClassEvent, OperateType.ADD);
    }
    ...
    public override async void ReviseInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        NetworkTCPServer.HttpSendAsync(pkg.Context, s_inf, EventType.ClassEvent, OperateType.REVISE);
    }
    ...
    public override async void DeleteInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        string body = JsonMapper.ToJson(new_list);
        NetworkTCPServer.HttpSendAsync(pkg.Context, body, EventType.ClassEvent, OperateType.DELETE);
    }
    ...
    public override async void SearchInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        string s_inf = JsonMapper.ToJson(inf);
        NetworkTCPServer.HttpSendAsync(pkg.Context, s_inf, EventType.ClassEvent, OperateType.SEARCH);
        await UniTask.Yield();
    }    
}