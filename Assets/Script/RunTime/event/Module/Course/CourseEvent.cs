...
public class CourseEvent : BaseEvent
{
    public override async void GetInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        HttpServer.HttpSendAsync(pkg.Context, inf, EventType.CourseEvent, OperateType.GET);
    }
    ...
    public override async void AddEvent(AsyncExpandPkg pkg)
    {
        ...
        HttpServer.HttpSendAsync(pkg.Context, body, EventType.CourseEvent, OperateType.ADD);
    }
    ...
    public override async void ReviseInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        HttpServer.HttpSendAsync(pkg.Context, s_inf, EventType.CourseEvent, OperateType.REVISE);
    }
    ...
    public override async void DeleteInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        string body = JsonMapper.ToJson(new_list);
        HttpServer.HttpSendAsync(pkg.Context, body, EventType.CourseEvent, OperateType.DELETE);
    }
    ...
    public override async void SearchInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        string s_inf = JsonMapper.ToJson(inf);
        HttpServer.HttpSendAsync(pkg.Context, s_inf, EventType.CourseEvent, OperateType.SEARCH);
        await UniTask.Yield();
    }  
}