...
public class MajorEvent : BaseEvent
{
    public override async void GetInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        NetworkTCPServer.HttpSendAsync(pkg.Context, s_inf, EventType.MajorEvent, OperateType.GET);
    }
    ...
    public override async void AddEvent(AsyncExpandPkg pkg)
    {
        ...
        NetworkTCPServer.HttpSendAsync(pkg.Context, s_inf, EventType.MajorEvent, OperateType.ADD);
    }
    ...
    public override async void ReviseInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        string s_inf = JsonMapper.ToJson(infs);
        NetworkTCPServer.HttpSendAsync(pkg.Context, s_inf, EventType.MajorEvent, OperateType.REVISE);
    }
    ...
    public override async void DeleteInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        string s_inf = JsonMapper.ToJson(infs);
        NetworkTCPServer.HttpSendAsync(pkg.Context, s_inf, EventType.MajorEvent, OperateType.DELETE);
    }
    ...
    public override async void SearchInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        NetworkTCPServer.HttpSendAsync(pkg.Context, s_inf, EventType.MajorEvent, OperateType.SEARCH);
        await UniTask.Yield();
    }
}